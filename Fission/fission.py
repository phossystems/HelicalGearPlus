...
class FusionEventHandler(object):
    ...
    def _wire_event(self, command, event, callback):
        ...
        events = {
            'command_created': lambda command, callback: _wire_handler(command.commandCreated, callback,
                                                                       adsk.core.CommandCreatedEventHandler),
            'destroy': lambda command, callback: _wire_handler(command.destroy, callback,
                                                               adsk.core.CommandEventHandler),
            'execute': lambda command, callback: _wire_handler(command.execute, callback,
                                                               adsk.core.CommandEventHandler),
            'activate': lambda command, callback: _wire_handler(command.activate, callback,
                                                                adsk.core.CommandEventHandler),
            'deactivate': lambda command, callback: _wire_handler(command.deactivate, callback,
                                                                  adsk.core.CommandEventHandler),
            'preview': lambda command, callback: _wire_handler(command.executePreview, callback,
                                                               adsk.core.CommandEventHandler),
            'input_changed': lambda command, callback: _wire_handler(command.inputChanged, callback,
                                                                     adsk.core.InputChangedEventHandler),
            'validate_inputs': lambda command, callback: _wire_handler(command.validateInputs, callback,
                                                                       adsk.core.ValidateInputsEventHandler),
            'key_down': lambda command, callback: _wire_handler(command.keyDown, callback,
            ...
            'mouse_click': lambda command, callback: _wire_handler(command.mouseClick, callback,
                                                                   adsk.core.MouseEventHandler),
            'mouse_double_click': lambda command, callback: _wire_handler(command.mouseDoubleClick, callback,
                                                                          adsk.core.MouseEventHandler),
            'mouse_down': lambda command, callback: _wire_handler(command.mouseDown, callback,
                                                                  adsk.core.MouseEventHandler),
            'mouse_move': lambda command, callback: _wire_handler(command.mouseMove, callback,
                                                                  adsk.core.MouseEventHandler),
            'mouse_up': lambda command, callback: _wire_handler(command.mouseUp, callback, adsk.core.MouseEventHandler),
            'mouse_wheel': lambda command, callback: _wire_handler(command.mouseWheel, callback,
                                                                   adsk.core.MouseEventHandler),
            'mouse_drag_begin': lambda command, callback: _wire_handler(command.mouseDragBegin, callback,
                                                                        adsk.core.MouseEventHandler),
            'mouse_drag': lambda command, callback: _wire_handler(command.mouseDrag, callback,
                                                                  adsk.core.MouseEventHandler),
            'mouse_drag_end': lambda command, callback: _wire_handler(command.mouseDragEnd, callback,
                                                                      adsk.core.MouseEventHandler),
            'selecting': lambda command, callback: _wire_handler(command.selectionEvent, callback,
                                                                 adsk.core.SelectionEventHandler)}
...
class InputFactory(FusionEventHandler):
    ...
    def create_int_spinner(self, id, name, initial_value=0, min=-2147483648, max=2147483647, step=1, tooltip='',
                           description='', help_image=None, on_change=None, on_validate=None, persist=True):
    ...
    def addValueInput(self, id, name, initial_value, units, tooltip='', description='', help_image=None, on_change=None,
                      on_validate=None, persist=True):
    ...
    def addStringInput(self, id, name, initial_value='', tooltip='', description='', help_image=None, on_change=None,
                       on_validate=None, on_eval=None, persist=True):
    ...
    def addSelectionInput(self, id, name, prompt=None, filter=None, tooltip='', description='', help_image=None,
                          on_change=None, on_validate=None, persist=False):
    ...
    def create_text_drop_down(self, id, name, items=[], default=None, values=[], tooltip='', description='',
                              help_image=None, on_change=None, on_validate=None, persist=True):
    ...
    def create_checkbox(self, id, name, initial_value=False, tooltip='', description='', help_image=None,
                        on_change=None, on_validate=None, persist=True):
    ...
    def create_textbox(self, id, name='', text='', height=2, read_only=False, tooltip='', description='',
                       help_image=None, on_change=None, on_validate=None, persist=True):
...
class SketchHelper(object):
    ...
    def add_arc_by_center_start_sweep(self, center, start, sweep, expect_end=None):
        ...
        self.curves.append(curve)
        if expect_end:
            assert curve.geometry.endPoint.distanceTo(
                expect_end) <= SketchHelper.CLOSE_ENOUGH or curve.geometry.startPoint.distanceTo(
                expect_end) <= SketchHelper.CLOSE_ENOUGH, 'End point of arc was not in the expected location. Expected ({}, {}) was ({}, {})'.format(
                expect_end.x, expect_end.y, curve.geometry.endPoint.x, curve.geometry.endPoint.y)
        return curve
